...
export function campaignFromV2StoreCampaign(rawCampaign = {}, campaignId = rawCampaign.id) {
    ...
    const campaign = {
        ...
        catalogEntries: rawCampaign[V2_COLLECTIONS.catalogEntries] || {},
        catalogEntriesList: valuesOrList(rawCampaign, V2_COLLECTIONS.catalogEntries, "catalogEntriesList"),
        catalogChangeEvents: valuesOrList(rawCampaign, V2_COLLECTIONS.catalogChangeEvents, "catalogChangeEventsList"),
        effectRequests: valuesOrList(rawCampaign, V2_COLLECTIONS.effectRequests, "effectRequestsList"),
        loreContributions: valuesOrList(rawCampaign, V2_COLLECTIONS.loreContributions, "loreContributionsList"),
