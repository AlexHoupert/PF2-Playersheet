...
export default function ImpulseEditor({ initialItem: initialItemProp, initialPayload, baseEntry, editorMode, catalogType = 'impulse', headerAction, onSave, onCancel, onSaveToDb, onSaveCatalogEntry }) {
    ...
    return (
        <CatalogEditorShell title={initialItem ? 'Edit Impulse' : 'Create Impulse'} headerAction={headerAction} loadingMessage={isLoading ? 'Loading impulse details...' : ''} error={error} pending={isSaving} saveLabel="Save Impulse" onSave={handleSave} onCancel={onCancel}>
