...
- Knowledge notes are Actor-owned and private by default. `sharedWithGm` and `sharedWithParty` are independent; Party-shared notes are loaded through a constrained Firestore query and rendered read-only at their Lore/Bestiary target.
